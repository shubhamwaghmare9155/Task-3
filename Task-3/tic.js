...
function myfunc()
{
	...
	// Checking of player X finsish
	//Checkingfor player 0 starts. Is player 0 won or not and after that disable all the other fields
	...
	else if((b3 == '0' || b3 == '0') && (b6 == '0' || b6 == '0') && (b9 == '0' || b9 == '0'))
	{
		document.getElementById('print').innerHTML = "Player 0 Won";
		document.getElementById("b1").disabled = true;
		document.getElementById("b2").disabled = true;p
		document.getElementById("b4").disabled = true;
		document.getElementById("b5").disabled = true;
		document.getElementById("b7").disabled = true;
		document.getElementById("b8").disabled = true;
